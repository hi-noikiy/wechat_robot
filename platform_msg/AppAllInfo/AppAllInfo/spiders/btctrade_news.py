...
import codecs  
import re
class btctrade_news_spider(scrapy.Spider):
    name = "btctrade_news_spider"
    allowed_domains = ["www.btctrade.im"]
    urls = [
...
#rules = [Rule(LinkExtractor(allow=['/apps/.+']), 'parse')]
    def parse(self, response):
        ...
        print "++++++++++++++++++++++",href
        yield Request("https://www.btctrade.im" +href, callback=self.parse_new_page)

...
import codecs  
import re
class coolcoin_news_spider(scrapy.Spider):
    name = "coolcoin_news_spider"
    allowed_domains = ["www.coolcoin.com"]
    urls = [
        #"http://www.wandoujia.com/tag/视频",
        #"http://www.dmoz.org/Computers/Programming/Languages/Python/Resources/"

        "https://www.coolcoin.com/gonggao/"
...
#rules = [Rule(LinkExtractor(allow=['/apps/.+']), 'parse')]
    def parse(self, response):
        ...
        print "++++++++++++++++++++++",href
        yield Request("https://www.coolcoin.com" +href, callback=self.parse_new_page)
